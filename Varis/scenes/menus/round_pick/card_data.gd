...
var Cards = [
	...
	new_card("Powerfull spells", "Increase damage by 20%", "res://graphics/projectiles/powerful_spell.png", "damage", 0.2),
	new_card("Nimble feet", "Increase movement speed by 10%", "res://graphics/projectiles/nimble_feet.png", "speed", 0.1),
	new_card("Tough skin", "Decrease damage taken by 10%", "res://graphics/projectiles/tough_skin.png", "reduction", 0.1),
