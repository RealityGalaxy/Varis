...
var Spells = {
	...
	"basic_earth":new_spell("basic_earth", 0.15, "res://scenes/projectiles/projectile.tscn", 3, 5, "res://scenes/projectiles/basic_earth/rock_throw.png"),
	"basic_air":new_spell("basic_air", 0.4, "res://scenes/projectiles/projectile.tscn", 15, 20, "res://scenes/projectiles/basic_air/air_bolt.png"),
	"basic_fire":new_spell("basic_fire", 1, "res://scenes/projectiles/projectile.tscn", 30, 40, "res://scenes/projectiles/basic_fire/fireball.png"),
	...
	"wind_wall":new_spell("wind_wall", 5, "res://scenes/spells/wall/wall.tscn", 0, 50, "res://scenes/spells/wall/Circle_(transparent).png"),
}
