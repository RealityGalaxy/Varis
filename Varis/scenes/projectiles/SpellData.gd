...
var Spells = {
	"basic":new_spell("basic", 0.2, "res://scenes/projectiles/projectile.tscn", 5, 10, "res://graphics/projectiles/basic.png"),
	...
	"basic_water":new_spell("basic_water", 0.5, "res://scenes/projectiles/projectile.tscn", 15, 20, "res://graphics/projectiles/basic_water.png"),
	...
	"shield":new_spell("shield", 7, "res://scenes/spells/shield/shield.tscn", 0, 50, "res://graphics/projectiles/Shield_2.png"),
	"wind_wall":new_spell("wind_wall", 5, "res://scenes/spells/wall/wall.tscn", 0, 50, "res://graphics/projectiles/Wind_wall.png"),
}
